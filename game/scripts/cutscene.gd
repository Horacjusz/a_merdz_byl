...
func play_escape_ending() :
	set_frames([
		load("res://assets/cutscene_asset/Escape_ending.png")
	])
	_play(0.2)

func play_insane_ending() :
	set_frames([
		load("res://assets/cutscene_asset/Insanity_ending.png")
	])
	_play(0.2)
	
func play_vine_ending() :
	set_frames([
		load("res://assets/cutscene_asset/Vine_ending.png")
	])
	_play(0.2)

func play_door(new_frames) :
	set_frames(new_frames)
	_play(0.3)

func _play(speed_scale) :
